...
### Graph visualization
- **`rfm/viz.py`**: builds a sample user–item edge list from **orders** for **`GET /api/graph/data`**.
...
| `backend/rfm/user_profile.py` | `GET /api/customer/{user_id}` — orders + optional churn score |
