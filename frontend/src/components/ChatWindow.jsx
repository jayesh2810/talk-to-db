    ...
    <div className="flex-1 overflow-y-auto px-4 py-4 space-y-6">
      {showExamples ? (
        ...
        <>
          ...
          {isLoading && (
            <div className="flex justify-start">
              <div className="flex items-center gap-2">
                ...
                <div className="flex gap-1 items-center bg-gray-800 border border-gray-700 rounded-xl px-4 py-3">
          ...
          {error && (
            <div className="flex justify-start">
              <div className="max-w-lg bg-red-950 border border-red-800 rounded-xl px-4 py-3 text-sm text-red-300">
